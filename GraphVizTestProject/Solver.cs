...
namespace GraphVizTestProject {
    class Solver {
        ...
        /// <returns></returns>
        private int GetAugmentalFlow(EduGraph graph, int[] augmentalPath, EduGraphVisualizer egVis = null) {
        ...
        private void StartAugmentalFlow(EduGraph graph, int[] augmentalPath, int augmentalFlow) {
        ...
        /// <returns></returns>
        private List<EdgeInfo> BuildMinimalCut(EduGraph graph, bool[] divisionOfVertices) {
