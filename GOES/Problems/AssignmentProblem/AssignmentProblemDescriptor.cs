...
namespace GOES.Problems.AssignmentProblem {
    class AssignmentProblemDescriptor : IProblemDescriptor {
        ...
        public ProblemExample[] ProblemExamples => new ProblemExample[] { 
            ...
            /*
             Это ошибка в алгоритме. Он в качестве минимального невычеркнутого элемента находит нуль, и,
             вычитая его из остальных, ничего не менят. И снова, и снова. Хороший алгоритм не должен допускать 
             невычеркнутый нуль.
             Вот примерный алгоритм Валентины Георгиевны для того этапа, на котором зацикливается


            Непарные вершины первой доли: вершины 0
            Переходим к вершинам правой доли: вершины 1
            Переходим к вершинам левой доли: вершины 2

            Помеченные строки и непомеченные столбцы

            0 - 1 - 2 - 3 - 4 

            Обход с непарной левой: 0
            Идём по всем тонким рёбрам (несколько чередующихся цепей зараз)
            Идём вправо: вершина 1
            Влево: 2
            Вправо: 3
            Влево: 4

            Строки/ столбцы помечены

            Помеченые строки и непомеченные столбцы => массив, из него выбираем мин.
            Из выделенных строк его вычитаем, из столбцов - прибавляем
             */
        };
